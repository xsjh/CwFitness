...
export function WelcomeExperience() {
  ...
  return (
    <main className="welcome-page" data-force-motion="true">
      ...
      <section className="welcome-image-break welcome-reveal welcome-image-scene welcome-motion-image" data-scroll-motion style={{ backgroundImage: "radial-gradient(circle at 76% 23%, rgba(192, 229, 139, .42), transparent 31%), linear-gradient(135deg, #294637, #10231c 56%, #07100e)", clipPath: "none" }}><img src={imageSet[0].src} alt={imageSet[0].alt} /><div><p className="welcome-kicker welcome-image-line">有计划，也有余地</p><h2 aria-label="把注意力留给眼前这一组。"><span className="welcome-image-line">把注意力留给</span><span className="welcome-image-line">眼前这一组。</span></h2></div></section>
