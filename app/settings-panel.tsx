...
export function SettingsPanel({ settings, busy, telemetryEnabled, onSave, onDelete, onExport, onPreviewRestore, onRestore, onTelemetryPreference, onPrepareDelete }: { settings: Settings; busy: boolean; telemetryEnabled: boolean; onSave: (settings: Settings) => Promise<void>; onDelete: () => Promise<void>; onExport: () => Promise<void>; onPreviewRestore: (backup: unknown) => Promise<BackupSummary | undefined>; onRestore: (backup: unknown) => Promise<void>; onTelemetryPreference: (enabled: boolean) => Promise<void>; onPrepareDelete: () => Promise<DeletionSummary | undefined> }) {
